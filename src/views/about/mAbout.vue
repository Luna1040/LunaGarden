<template>
  <div class="aboutUs">
    <Header
      ...
      user-icon="images/userIcons/userIcon.jpg?token=AHM7AP6WQA4C52Z5VTSU4NS7UT72M"
    ...
    <div class="about">
      ...
      <div class="cardGroup">
        <figure>
          <img src="images/userIcons/userIcon.jpg?token=AHM7AP6WQA4C52Z5VTSU4NS7UT72M" alt />
