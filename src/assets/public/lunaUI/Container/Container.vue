<template>
    <div class="lunaContainer" :style="[containerPadding, containerWidth, containerHeight, containerMaxHeight, containerMaxWidth, containerScrollable, containerBackground, containerBorder, containerRadius, containerShadow, containerImage, flexStyle]" :class="[className, {squareCorner: corner === 'square', smallCorner: corner === 'small', filletCorner: corner === 'fillet', largeCorner: corner === 'large', fullCorner: corner === 'full', roundCorner: corner === 'round'}, {'': theme === 'light', 'darkContainer': theme === 'dark'},{darkShadow: shadowStyle === 'dark', lightShadow: shadowStyle === 'light'},{flex: flex, block: !flex}]">
        <slot></slot>
    </div>
</template>
