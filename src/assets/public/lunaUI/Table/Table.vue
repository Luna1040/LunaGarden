<template>
    <table class="lunaTable" cellspacing="0" :style="[tableStyles, baseBorder]" :class="[{lightTable: theme === 'light', darkTable: theme === 'dark'}, {headerFixed: headerFixed}, {lightShadow: shadowStyle === 'light', darkShadow: shadowStyle === 'dark'},{squareCorner: corner === 'square', smallCorner: corner === 'small', filletCorner: corner === 'fillet', largeCorner: corner === 'large', fullCorner: corner === 'full'},{stripeRow: stripe}]">
        <thead :style="[headerStyles]">
        <tr>
            <th v-for="col in columns"
                :style="[baseBorder, {width: col.width + 'px'}]">{{ col.title }}</th>
        </tr>
        </thead>
        ...
        <tr v-else v-for="(row, rowIndex) in data"
