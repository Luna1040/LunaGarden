<template>
  ...
  <header class="header" :class="{collapse: isCollapse}">
    ...
    <nav v-show="!isCollapse" class="menuGroup">
      ...
      <figure v-for="i in menuList" :key="i.id" class="menuItem" :class="{menuItemActive: activeID === i.id}"
              @click="choiceMenu(i.id, i.link)">
    ...
    <div class="guide">
      ...
      <Button color="#eb7290" icon="iconfont icon-guide" :icon-size="22" pre :width="130" :height="44" corner="full"
              @click="toAbout">
