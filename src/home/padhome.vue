<template>
    <div :class="theme">
        ...
        <!--<button class="material" @click="changeTheme">Don't like this Design style?</button>-->
        <!--<router-link class="guide" to="./guide">How it works?</router-link>-->
        <!--<router-link class="guide" to="./pwKeeper">Try Password Keeper(Beta)</router-link>-->
